...
then
    ...
    do
        ...
        echo "...QUERY-5..."
        echo "...QUERY-5..." >> ${4}/daa_ss_bcastjoins_results_facebookpresto${5}.txt
        ...
        echo "...QUERY-6.1..."
        echo "...QUERY-6.1..." >> ${4}/daa_ss_bcastjoins_results_facebookpresto${5}.txt
        ...
        echo "...QUERY-6.2..."
        echo "...QUERY-6.2..." >> ${4}/daa_ss_bcastjoins_results_facebookpresto${5}.txt
        ...
        echo "...QUERY-7..."
        echo "...QUERY-7..." >> ${4}/daa_ss_bcastjoins_results_facebookpresto${5}.txt
